...
<head>
    ...
    <link rel="stylesheet" href="assets/scss/_people.scss">
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav w-100 d-flex flex-column flex-lg-row justify-content-start justify-content-lg-end align-items-center ">
                    ...
                    <li class="nav-item d-flex d-lg-block justify-content-center mr-0 mr-lg-4">
                        <a class="nav-link d-flex justify-content-center align-items-center" href="#" data-toggle="collapse" data-target=".navbar-collapse.show">Contact
                            Us</a>
                    </li>
                    <li class="divider"></li>
                ...
                <!--Action button-->
                <div class="h-100 d-flex justify-content-center"><a class="nav-link nav-button d-flex justify-content-center align-items-center px-1 py-2 mt-3 mt-lg-0"
...
<section class="welcome">
    ...
    <div class="container d-flex flex-column align-items-start justify-content-center h-100">
        <h1 class="mb-4">Crowd funding <br>
            for saving lives</h1>
        <h3 class="mb-5">Start saving people today
        </h3>
        <a href="#" class="btn d-flex justify-content-center align-items-center mb-3">Start helping
            <span class="pl-3"><svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                <path d="M16.8963 8.24978L10.1673 1.52071C9.44335 0.796789 8.26542 0.796789 7.54151 1.52071C6.81759 2.24462 6.81759 3.42255 7.54151 4.14647L10.124 6.729H1.77079C0.794738 6.729 0 7.52374 0 8.49983C0 9.47591 0.794738 10.2706 1.77079 10.2706H10.124L7.54151 12.8532C6.81759 13.5771 6.81759 14.755 7.54151 15.4789C7.90345 15.8409 8.37874 16.0222 8.85474 16.0222C9.33073 16.0222 9.80529 15.8416 10.168 15.4789L16.897 8.74984C17.0344 8.61172 17.0344 8.3879 16.8963 8.24978Z"
                      fill="white"/>
            </svg></span>
        </a>
        <a href="#" class="link">Learn more about project</a>
...
<section class="people">
    <div class="container-fluid container-sm">
        <div class="row">
            <div class="col-1"></div>
            <div class="col"><h5 class="mb-5 mt-5">People who need Your help the most</h5></div>
            <div class="col-1"></div>
        </div>
        <div class="row">
            <div class="col-1"></div>
            <div class="col-12 col-lg d-flex justify-content-center mb-4 mg-lg-0">
                <a href="#" class="card-wrapper">
                    <div class="card w-100">
                        <img class="card-img-top" src="assets/img/image1.png" alt="Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-1">Chicago, IL</h6>
                            <h5 class="card-title mb-3">Kate, 8 yrs</h5>
                            <p class="card-text mb-4">Lorem Ipsum - це текст-"риба", що використовується в друкарстві та
                                дизайні...</p>
                            <div class="percentage-bar mb-4">
                                <div class="percentage-amount"></div>
                            </div>
                            <p class="raised">Raised $10 200 <span>of $25 000 </span></p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-12 col-lg d-flex justify-content-center mb-4 mg-lg-0">
                <a href="#" class="card-wrapper">
                    <div class="card w-100">
                        ...
                        <div class="card-body">
                            <h6 class="card-subtitle mb-1">Los Angeles, CA</h6>
                            <h5 class="card-title mb-3">DIlan, 10 yrs</h5>
                            <p class="card-text mb-4">Lorem Ipsum - це текст-"риба", що використовується в друкарстві та
                                дизайні...</p>
                            <div class="percentage-bar mb-4">
                                <div class="percentage-amount"></div>
            ...
            <div class="col-12 col-lg d-flex justify-content-center mb-4 mg-lg-0">
                <a href="#" class="card-wrapper">
                    <div class="card w-100">
                        <img class="card-img-top" src="assets/img/image2.png" alt="Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-1">New York</h6>
                            <h5 class="card-title mb-3">CIndy, 8 yrs</h5>
                            <p class="card-text mb-4">Lorem Ipsum - це текст-"риба", що використовується в друкарстві та
                                дизайні...</p>
                            <div class="percentage-bar mb-4 px-2">
                                <div class="percentage-amount"></div>
                            </div>
                            <p class="raised">Raised $10 200 <span>of $25 000 </span></p>
                        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-5 mb-5">
            <a href="#" class="see-all">See all <span class="pl-5"><svg width="10" height="20" viewBox="0 0 10 20"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="svg-path"
                      d="M8.12498 10L0 18.125V20L10 10L0 0V1.87498L8.12498 10Z" fill="#0E6B3B"/></svg></span></a>
        </div>
    </div>
</section>
<section class="success-stories pb-3">
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-1 d-none d-lg-block"></div>
            <div class="col">
                <a href="#" class="stories-link mb-3 d-block w-50">Success Stories</a>
            </div>
        </div>
        <div class="row">
            <div class="col-1 d-none d-lg-flex justify-content-center align-items-center">
                <a class="carousel-control-prev"
                   href="#carouselExampleIndicators" role="button"
                   data-slide="prev">
                    <img class="" src="assets/img/control-prev.svg" alt="">
                    <span class="sr-only">Previous</span>
                </a>
            </div>
            <div class="col">
                <div id="carouselExampleIndicators" class="carousel  slide carousel-fade d-flex justify-content-center" data-touch="true"
                     data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="left col-12 col-lg mb-3 mb-lg-0"><a href="#"><img class="img-fluid"
                                                                                              src="assets/img/carousel-img.png"
                                                                                              alt="First slide"></a>
                                </div>
                                <div class="right col-12 col-lg d-flex flex-column justify-content-center">
                                    <a href="#" class="stories-header mb-3">Recovered Elison
                                        and her happy family</a>
                                    <p>Lorem Ipsum - це текст-"риба", що використовується в друкарстві та дизайні. Lorem
                                        Ipsum
                                        є, фактично, стандартною "рибою" аж з XVI сторіччя...
                                    </p>
                                    <a href="#" class="stories-read">Read more</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <ol class="carousel-indicators m-0 p-0 d-flex">
            ...
            <div class="col-1 d-none d-lg-flex justify-content-center align-items-center">
                <a class="carousel-control-next"
                   href="#carouselExampleIndicators" role="button"
                   data-slide="next">
                    <img class="" src="assets/img/control-next.svg" alt="">
