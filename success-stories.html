...
<head>
    ...
    <title>Fundraising/Success-Stories</title>
    <!--Fonts-->
...
<section class="success-stories-blog">
    <div class="container">
        <h3 class="success-stories-blog-header py-5">Success Stories</h3>
        <div class="success-stories-blog-content pb-5 d-flex">
            <div class="left h-100 pb-3 pb-lg-0">
                <a href="#" class="text-decoration-none">
                    <div class="card card-main h-100">
                        <div class="card-image"
                             style="background-image: url('assets/img/success-stories-blog-1.png');"></div>
                        <div class="card-body pl-0">
                            <h5 class="card-title">Recovered Elison and her happy family enjoying completely new
                                life</h5>
            ...
            <div class="right">
                <a href="#" class="text-decoration-none">
                    <div class="card d-flex flex-row pb-3 pl-0 pl-lg-5">
                        <div class="card-image w-75"
                             style="background-image: url('assets/img/success-stories-blog-2.png');"></div>
                 ...
                 <a href="#" class="text-decoration-none">
                    <div class="card d-flex flex-row pt-3 pl-0 pl-lg-5">
                        <div class="card-image w-75"
                             style="background-image: url('assets/img/success-stories-blog-3.png');"></div>
                        <div class="card-body pr-0">
                            <p class="date">August 12</p>
                            <h5 class="card-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h5>
                        </div>
...
<section class="more-stories">
    <div class="container">
        <h5 class="more-stories-header py-4">More stories</h5>
        <div class="row d-flex justify-content-center">
            <div class="col-9 col-lg py-3 py-lg-0">
                <a href="#" class="text-decoration-none">
                    <div class="card">
                        <img class="card-img-top" src="assets/img/more-stories-1.png" alt="">
                        <div class="card-body pl-0">
            ...
            <div class="col-9 col-lg py-3 py-lg-0">
                <a href="#" class="text-decoration-none">
                    <div class="card">
                        <img class="card-img-top" src="assets/img/more-stories-2.png" alt="">
                        <div class="card-body pl-0">
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore</p>
                        </div>
            ...
            <div class="col-9 col-lg py-3 py-lg-0">
                <a href="#" class="text-decoration-none">
                    <div class="card">
                        <img class="card-img-top" src="assets/img/more-stories-3.png" alt="">
                        <div class="card-body pl-0">
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore</p>
                        </div>
        ...
        <div class="pb-3 pt-5 w-100 d-flex justify-content-center"><a href="#" class="see-all w-50">Load more
            <svg class="ml-3" width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="svg-path"
                      d="M8.00001 6.50002L1.49999 3.05176e-05L7.62939e-06 3.05176e-05L8.00001 8.00003L16 3.05176e-05L14.5 3.05176e-05L8.00001 6.50002Z"
                      fill="#0E6B3B"/>
            </svg>
        </a></div>
    </div>
